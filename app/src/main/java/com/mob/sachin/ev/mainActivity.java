...
public class mainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView userNameTextView = (TextView) headerView.findViewById(R.id.userNameTV);
        TextView userEmailTextView = (TextView) headerView.findViewById(R.id.userEmailTV);
